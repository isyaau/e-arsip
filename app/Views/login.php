                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="/login/auth" method="post">
                                        <div class="form-group">
                                            <input type="text" name="username" class="form-control form-control-user" value="<?= set_value('username') ?>" id=" exampleInputEmail" aria-describedby="emailHelp" placeholder="Username">
                                        </div>
                                        <div class="form-group">
